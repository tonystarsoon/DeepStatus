...
public class GuideFragment extends Fragment {
    ...
    public static GuideFragment newInstance(TutorialItem tutorialItem, int page) {
        GuideFragment helpTutorialImageFragment = new GuideFragment();
