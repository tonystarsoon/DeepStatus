package za.co.riggaroo.helptut.guide;
...
import za.co.riggaroo.guide.tutorial.GuideActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadTutorial() {
        Intent mainAct = new Intent(this, GuideActivity.class);
        mainAct.putParcelableArrayListExtra(GuideActivity.MATERIAL_TUTORIAL_ARG_TUTORIAL_ITEMS, getTutorialItems(this));
