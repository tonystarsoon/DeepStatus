 ...
 */
public class ListViewFragment extends BaseRefreshFragment implements PullToRefreshView.OnRefreshListener {
    ...
    private class SampleAdapter extends ArrayAdapter<Map<String, Integer>> {
        ...
        SampleAdapter(Context context, int layoutResourceId, List<Map<String, Integer>> data) {
